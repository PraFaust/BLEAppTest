...
PRIMARY_SERVICE_UUID128(service_ready_for_sky, uuid_service_rfs)
    CHARACTERISTIC_UUID128(char_button_state, uuid_service_rfs_button_characteristic, (gGattCharPropRead_c | gGattCharPropNotify_c))
        VALUE_UUID128(value_button_state, uuid_service_rfs_button_characteristic, (gPermissionFlagReadable_c), 1, 0x00)
        CCCD(cccd_button_status)
    CHARACTERISTIC_UUID128(char_led_state, uuid_service_rfs_led_characteristic, (gGattCharPropRead_c | gGattCharPropWrite_c | gGattCharPropNotify_c))
        VALUE_UUID128(value_led_state, uuid_service_rfs_led_characteristic, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 4, 0x00, 0x00, 0x00, 0x04)
